...
const randompassword_1 = __nccwpck_require__(516);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const password = (0, randompassword_1.generateRandomPassword)(minLength, maxLength, useSpecialChars);
            if (!debug) {
...
function generateRandomPassword(minLength, maxLength, useSpecialChars = false) {
